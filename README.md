...
Wake (state 0), N3 (state 2), and 44 experimental states (states 5--48) were each run for 120 simulated seconds. 
Testing was iterative, with each group of states informed by the preceding results. 
States 35, 38, 39, 40, 42, and 44 were each repeated with three random seeds; N3 was repeated similarly as a reference.
