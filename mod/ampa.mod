...
PARAMETER{ :see line 390 of currents.cpp (from Giri Krishnan) for parameter values
	...
	Alpha  = 1.1  (/ms mM):forward (binding) rate (currents.cpp line 394)
	Beta   = 0.19 (/ms):backward (dissociation) rate (currents.cpp line 394)
